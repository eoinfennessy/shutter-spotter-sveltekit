...
import Heatmap from "$src/lib/Heatmap.svelte";
	...
	const tileData = [
		...
		{ title: "Average Locations per User", value: +data.avgLocationsPerUser.toFixed(2), class: "is-success" },
		{ title: "Average Photos per User", value: +data.avgPhotosPerUser.toFixed(2), class: "is-danger" },
		{ title: "Average Photos per Location", value: +data.avgPhotosPerLocation.toFixed(2), class: "is-link" },
	];
</script>
...
<div class="box">
	...
	<div class="tile is-ancestor">
		<div class="tile is-3 is-vertical is-parent">
			<AnalyticsTiles tileData={tileData} />
		</div>
