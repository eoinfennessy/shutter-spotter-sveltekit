...
<div class="box navbar has-text-centered columns m-2">
	<a href="/donate" class="column is-4">
		<i class="fas fa-hand-holding-usd fa-3x" style="color:rgb(153, 196, 74)" />
	</a>
	<div class="navbar-item has-dropdown is-hoverable is-4">
		<a href="/user/{$user._id}/dashboard" class="navbar-link">
